...
<html lang="en">
  ...
  <body>
    <main role="main">
      ...
      <h2>Bienvenue à L'Escale Canine</h2>
      <p>L'Escale Canine, c'est un tout nouveau chenil flambeau neuf pouvant accueillir chats, chiens et oiseaux!</p>
      <p>Vos compagnons de tous les jours seront accueillis comme des rois. Même s'il nous arrive de manger des chiens, nous promettons que cela n'arrivera pas avec le vôtre. Faites-nous confiance!</p>
      
      <h3>Nous vous souhaitons une agréable navigation sur notre nouveau site internet!</h3>
    </main> 
  </body>
</html>